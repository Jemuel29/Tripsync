<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintableReceipt.aspx.cs" Inherits="Tripsync.PrintableReceipt" %>
    ...
    <form id="form1" runat="server">
        <div class="print-container">
            <div class="receipt-header">
                <img src="/Picture/logo.png" alt="Tripsync Logo" class="company-logo" />
                <div class="receipt-title">Official Receipt</div>
                <div class="receipt-subtitle">TRIPSYNC CINEMAS</div>
            </div>
            ...
            <div class="receipt-footer">
                <p>Thank you for choosing Tripsync Cinemas!</p>
                <p style="font-style:italic;">This is your official receipt.</p>
                <p>© 2025 Tripsync Cinemas</p>
            </div>
